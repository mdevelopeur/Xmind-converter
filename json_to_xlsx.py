...
for item in all_data:
    data_list.append(["Схема событий", "Россия", "Центральный", "Московская область", "Населённые пункты (сделать районы, разобрать от большого к маленькому)"] + item["address"].split(", ")[1:3] + ["Церкви", item["name"]])
